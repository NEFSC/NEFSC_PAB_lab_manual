...
To get your email and computer fully set up with ITD, follow the following steps. IT HelpDesk tickets can be submitted [here.](https://apps-st.fisheries.noaa.gov/jira/servicedesk/customer/portal/3) 
...
1. **Orientation/training protocols for new analysts:** Link to [NEFSC Baleen Whale (Acoustic) Analysis Training Google Drive](https://drive.google.com/drive/folders/1RCjeyheAep7viZuVY4wvJeAeB8Db3YoF?usp=drive_link). For more information on species analysis protocol, see [protocol page](https://nefsc.github.io/NEFSC_PAB_lab_manual/content/Analysis/Analysis.html#analysis-protocols).
...
Note: VPN connection required to access. If access issues arise, submit IT ticket with [NEFSC IT service desk](https://apps-st.fisheries.noaa.gov/jira/servicedesk/customer/portal/3). For more information on the lab's server, see [Server Structure](https://nefsc.github.io/NEFSC_PAB_lab_manual/content/LabManagement/PA_server_structure.html) page.
