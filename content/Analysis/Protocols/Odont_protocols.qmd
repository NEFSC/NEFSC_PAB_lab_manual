...
* Code: FPOD\_ODONTOCETE  
* Link to analysis protocol page

## SPICE Odontocete Detector 

Triton's odontocete click detector; written by [Kait Frasier](https://github.com/MarineBioAcousticsRC/Triton) 

* Code: MATLAB\_TRITON\_ODONTOCETE\_FIXED\_SPICE  
* Link to analysis protocol page
...
* Code: R_BANTER_ML (double check this)
...
* Code: MATLAB\_BEAKED\_FIXED\_ALBA\_CNN  
* Link to analysis protocol page
...
* Code: PAMGUARD\_ODONTOCETE\_CLICK  
