...
![](/figs/Spec_images/Odont/Odont_diagrams/click-spectra-species.PNG)
::: 
::: {.column width="10%"}
:::
::::::::::::::
...
#### [Atlantic White-sided dolphin](https://docs.google.com/document/d/1nUuGBs1qRno3_GFamIC85CaydllmZDq2lfgAAAExPCU/edit?usp=sharing)
...
![](/figs/Spec_images/Odont/Atlantic_white_sided_dol_spec.png)

:::
::: {.column width="47%"}

![](/figs/infographics/odont_noaafisheries/Atlantic_whiteside.jpg){width=70%}
...
#### [Common dolphin](https://docs.google.com/document/d/1uY5mGhXhlmHuG7IofNmRibhJXvy2i9aDRLVH-8A9r5s/edit?usp=drive_link)
...
#### [Risso's dolphin](https://docs.google.com/document/d/1UpS5NgtaA7IpuwrNWRjkK9mA6nDYDmPvZGp5Yvg_R8Q/edit?usp=drive_link)
...
![](/figs/Spec_images/Odont/Rough_toothed_spec.png){width=100%}
...
![](/figs/infographics/odont_noaafisheries/Roughtoothed_noaa.png){width=80%}
...
#### [Pilot whale sp.](https://docs.google.com/document/d/1YZqd9g4_gWXkwyVaLpKDVLpGgDkQGbiOGkfLCzzWY8A/edit?usp=drive_link)
...
![](/figs/Spec_images/Odont/Short_finned_pilotwhale_spec.png){width=100%}
...
## [**Beaked Whales**](/content/Analysis/Species_list/beaked-whale/Beaked_whale_guide_20190812.docx)
...
Each beaked whale species in the Northeast Region have slightly different click structures, as shown below in a combined click power spectra plot. Note, the power spectra are average values for each species, and individual clicks for each species may differ slightly. Under each beaked whale species heading is a an exemplar click's Wigner plot, which is the primary tool for determining beaked whale species from a click. Wigner plots were made in Pamguard and are high resolution spectrograms that show the details of the click's spectral structure. For more information on this software, see our [software page](https://nefsc.github.io/NEFSC_PAB_lab_manual/content/Software/Software.html#pamguard). 
:::
::: {.column width="50%"}
...
#### [Sowerby’s beaked whale](https://docs.google.com/document/d/1fzt4qKthATwvIeoa5tpAuxNa8YdhIJS79hBrDEWt1R0/edit?usp=sharing)
...
#### [Blainville’s beaked whale](https://docs.google.com/document/d/1CBKP7d4TKCwSBYdR8qxWlQwtbnl6vNteKib7Ym5UjsM/edit?usp=sharing)
...
#### [Gervais’ beaked whale](https://docs.google.com/document/d/1m7JJLLo97au3pXitotAAWsBX9z0q2CygTXkDTH_n69E/edit?usp=sharing)
...
#### [True’s beaked whale](https://docs.google.com/document/d/1NYYAOxbIV8IPPkS_KWQn4AT9ywlYSZjoJGg5pjJyA5U/edit?usp=sharing)
...
#### [Goose beaked whale](https://docs.google.com/document/d/1bpcA8_C_YivCNP4Dk2tKFUXws8y_w7oGNu4fC2JrmpA/edit?usp=sharing)
...
#### [**Gulf of Mexico’s Beaked whale (BWG, unknown)**](/content/Analysis/Species_list/beaked-whale/BWG.qmd)
...
![Kogia click spectra: PSD of the energy distribution within Kogia clicks ](/figs/Spec_images/Odont/spectra/Kogia.jpg){width=100%}
...
![Narrow Band High Frequency click (*Malinka et al. 2021*)](/figs/Spec_images/Odont/Odont_diagrams/High-band.frequency.click.png){width=100%}
